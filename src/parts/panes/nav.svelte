...
import { shard, nav } from "#scripts/stores";
import { save_napkin } from "#scripts";
...
<nav class="nav">
  ...
  <div>
    ...
    <button class="ui rounded">
      <a target="_blank" href="https://github.com/Sup2point0/avidity">
        <svg id="nav-github-icon"
...
#nav-title {
  margin-right: 0.5em;
  font-family: 'Kalam', 'Geologica', 'Segoe UI', system-ui, sans-serif;
  font-size: 200%;
  font-weight: 700;
  background: linear-gradient(90deg, #9090f1, #f190f1);
